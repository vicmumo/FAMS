...
<aui:form action="<%=updateComplianceActionURL%>" method="post">
	...
	<!--<select name="firstapprover">
	    ...
	    <option value="${compliance.firstapprover}">Denied</option>	    
	</select>  -->
	...
	<aui:input type="submit" value="Approve to the next step.."
		name="firstApprover"></aui:input>
	<hr />
	<hr />
	<aui:input type="submit" value="Decline to the next step.."
		name="update"></aui:input>
</aui:form>