...
<portlet:actionURL name="updateCompliance" var="updateComplianceActionURL"/>
 
<aui:form action="<%=updateComplianceActionURL%>" name="complianceForm" method="POST"/>
...
<aui:form action="<%= updateComplianceActionURL %>" method="post" >
    ...
    <aui:input name="complianceId" type="text" value="<%=Long.parseLong(complianceId)%>"/>
    <aui:input name="firstName" type="text" value="${compliance.firstName}"/>
    <aui:input name="lastName" type="text" value="${compliance.lastName}"/>
    <aui:input name="branchName" type="text" value="${compliance.lastName}" />
    <aui:input name="payrollNo" type="text" value="${compliance.payrollNo}" />
    <aui:input name="terminationReason" type="text" value="${compliance.terminationReason}"/> 
    <aui:input name="terminationCode" type="text" value="${compliance.terminationCode}"/> 
    <aui:input name="formerBranch" type="text" value="${compliance.formerBranch}"/>  
    <!-- Kaleo records -->
    ...
    <hr />
    <hr />
    <aui:input type="submit" value="Submit..." name="secondApprover"></aui:input>
