 ...
 * @generated
 */
public class ComplianceFinderBaseImpl extends BasePersistenceImpl<Compliance> {

	public ComplianceFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return getCompliancePersistence().getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ComplianceFinderBaseImpl.class);
